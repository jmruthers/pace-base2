...
export function ApplicationDetailDialog({
  ...
  return (
    <Dialog open={detailRow != null} onOpenChange={onOpenChange}>
      {detailRow != null ? (
        <DialogContent>
          <DialogHeader>
          ...
          <DialogBody className="grid gap-4">
            ...
            <ApplicationDetailChecksSection
              sortedDetailChecks={sortedChecks}
              rpcCheckActionsEnabled={rpcCheckActionsEnabled}
              scope={scope}
              onRequestSatisfyCheck={onRequestSatisfyCheck}
              onRequestRejectCheck={onRequestRejectCheck}
              onRequestReissueLink={onRequestReissueLink}
            />
          </DialogBody>
          <ApplicationDetailFooterActions
            detailRow={detailRow}
            scope={scope}
...
function ApplicationEvidenceSection({
  evidenceQuery,
  onRetryEvidence,
}: {
  evidenceQuery: Pick<UseQueryResult<ApplicationEvidenceRow[]>, 'data' | 'isLoading' | 'error'>;
...
function ApplicationDetailChecksSection({
  sortedDetailChecks,
  rpcCheckActionsEnabled,
  scope,
  onRequestSatisfyCheck,
...
function ApplicationDetailFooterActions({
  detailRow,
  scope,
  onApproveRequest,
  onRejectRequest,
