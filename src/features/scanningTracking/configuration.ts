...
import type {
  ...
  TrackingMemberRow,
  TrackingScanEventRow,
  TrackingScanPointRow,
  TrackingSearchResult,
} from './trackingTypes';
import type {
  PointSummaryRow,
  PresenceGroup,
  PresenceParticipantRow,
  TrackingParticipantSnapshot,
  TrackingSnapshot,
} from './trackingPresenceTypes';

type PersonRecord = TrackingApplicationRow['core_person'];
