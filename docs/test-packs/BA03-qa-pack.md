...
| S-17 | AC-17 | /forms | workflowType = 'base_registration' is selected | 1) Open `/forms`. 2) The builder renders. 3) Observe the resulting UI/system response. | the Registration Type Binding Panel appears with all active types for the event listed as checkboxes. (FB-PC-08) | Pass | - |
